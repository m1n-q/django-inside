...
SECRET_KEY = 'django-insecure-@ccrstt2+1*t2(6vs$pjc^&rauv1$&6a8$lsuqb@$4$v+0h&p)'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR / 'Day06/templates/share' ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
BOOTSTRAP5 = {
    ...
    "css_url": {
        "url": "https://cdn.jsdelivr.net/npm/bootstrap@5.0.2-beta2/dist/css/bootstrap.min.css",
